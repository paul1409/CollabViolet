...
public class CircularStateNode extends RectangularNode {
  ...
  public void setFinal(boolean newValue) {
    ...
    if (finalState) setBounds(new Rectangle2D.Double(x - DEFAULT_GAP, y - DEFAULT_GAP,
        DEFAULT_DIAMETER + 2 * DEFAULT_GAP, DEFAULT_DIAMETER + 2 * DEFAULT_GAP));
    else setBounds(new Rectangle2D.Double(x + DEFAULT_GAP, y + DEFAULT_GAP, DEFAULT_DIAMETER, DEFAULT_DIAMETER));
  }
