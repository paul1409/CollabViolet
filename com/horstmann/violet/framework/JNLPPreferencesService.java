...
public class JNLPPreferencesService extends PreferencesService {
  /**
   * Gets an instance of the service, with storage location derived from the
   * JNLP code base.
   */
  ...
  /**
   * Gets a string of somesort
   * @param key a key
   * @param defval ...what?
   * @return errors or the defval
   */
  ...
  /**
   * Puts a key with a value somewhere
   * @param key a key
   * @param value value
   */
