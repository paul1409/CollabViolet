...
public class ExtensionFilter extends FileFilter {
   ...
   * @param extensions the accepted extensions (e.g. new String[] { ".woozle",
   *          ".wzl" })
   */
   ...
   * Constructs an extension file filter.
   * @param description the description (e.g. "Woozle files")
   * @param extensions the accepted extensions, separated by |
   *          (e.g.".woozle|.wzl" })
   */
  public ExtensionFilter(String description, String extensions) {
    this.description = description;
  ...
  /**
   * Checks for acceptable save location
   * @param f file
