...
public interface Node extends Serializable, Cloneable {
   ...
   * @param d the direction from the center of the bounding rectangle towards
   *          the boundary
   ...
   * @param p1 the point that the user selected asthe starting point. This may
   *          be used as a hint if edges are ordered.
   ...
   * @param node the parent node, or null if the node has no parent
   */
