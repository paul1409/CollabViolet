        ...
        addMouseMotionListener(new MouseMotionAdapter() {
            public void mouseDragged(MouseEvent event) {
                ...
                if (dragMode == DRAG_MOVE && lastSelected instanceof Node) {
                    ...
                    // we don't want continuous layout any more because of
                    // multiple selection
                    // graph.layout();
                    ...
                    Rectangle2D.Double lasso = new Rectangle2D.Double(Math.min(x1, x2), Math.min(y1, y2),
        ...
        try {
            ...
            if (response == 200) {
                ...
                while ((ipl = in.readLine()) != null) {
                    ...
                    // System.out.println(theCD.getCommand().getClass()); //
                    // Mark
